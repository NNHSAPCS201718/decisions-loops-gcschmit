...
public class Notes
{
    public static void ifExample()
    {
         ...
         *      1.0 (exclusive): [0.0, 1)
         *      
         *      To generated a random integer between 0 (inclusive) and
    ...
    public static void stringExample()
    {
        ...
        /*
         * The equals method returns true if the two objets are equal.
         ...
         *      not be evaluated because the AND operation is already false.
         */
         ...
         *      not be evaluated because the OR operation is already true.
         *      
    ...
    public static String getStudentClass( int gradeNumber )
    {
        ...
        switch( gradeNumber )
        {
            ...
            /*
             * default mathces everything not matched by one of the cases
             */
            default:
            {
    ...
    public static void assignmentOperatorExample()
    {
         ...
         *      same as in Python
         *      perform the specified operation and then assign the
         *          resulting value
         */
        int x = 7;
        int y = 7;
