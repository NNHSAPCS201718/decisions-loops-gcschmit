...
public class Notes
{
    ...
    {
        /*
         * The Math.random method returns a double between 0.0 (inclusive)
         *      and 1.0 (exclusive): [0.0, 1)
         *      
        ...
        /*
         * if-else statement
         *      else block is executed in the conditional for the if
         *          statement is false
         */
        if( coinFlip == 1 )
        {
    ...
    public static boolean doublesAreEqual( double num1, double num2 )
    {
         ...
         *  For "equal" numbers this is probably not the case due to
         *      floating-point rounding and, therefore, not what we want.
